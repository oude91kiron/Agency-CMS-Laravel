  ...
  <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
    ...
    <ul class="navbar-nav navbar-nav-right">
      <li class="nav-item dropdown d-none d-lg-block">
        <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="#">+ Create New Agency</a>
      </li>
          ...
          <a class="dropdown-item preview-item">
            ...
            <div class="preview-item-content">
              <form method="POST" action="{{route('logout')}}" class="dropdown-item preview-item">
                @csrf
              <input type="submit" value="logout" class="preview-subject mb-1">
              </form>
            </div>
          </a>
